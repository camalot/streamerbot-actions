...
{
    [JsonProperty("alpha")]
    public PayloadData Alpha { get; set; } = new PayloadData() { Rarity = Rarity.Alpha };

    [JsonProperty("bravo")]
    public PayloadData Bravo { get; set; } = new PayloadData() { Rarity = Rarity.Bravo };

    [JsonProperty("special")]
    public PayloadData Special { get; set; } = new PayloadData() { Rarity = Rarity.Special };
